...
const FilterFormProductCreate: React.FC<FilterFormProps> = ({filters, onChange}) => {
    const [filterRows, setFilterRows] = useState<IFilterValueProductForm[]>([]);
...
export default FilterFormProductCreate;
